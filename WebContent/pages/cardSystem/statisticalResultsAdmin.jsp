          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <%} %>
                <%if(authority.equals("Dean")){ %>
				<li class="dean"><a href="DrawStatisticst"><i class="fa fa-circle-o"></i> 学院统计</a></li>
				<%} %>
				<%if(authority.equals("Instructor")){%> 
          ...
          <div class="row">
				...
				<!-- SELECT2 EXAMPLE -->
				  <div class="box box-info">
					<div class="box-header with-border">
					  <h3 class="admin box-title">全校学生消费均值(单位:元)</h3>
			 ...
			 <div class="col-xs-6 col-md-6">
				<!-- SELECT2 EXAMPLE -->
				  <div class="box box-info">
					<div class="box-header with-border">
					  <h3 class="admin box-title">全校学生消费次数(单位:次)</h3>
					  <div class="box-tools pull-right">
						<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
					  </div>
					</div><!-- /.box-header -->

                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10 col-md-6">
                        <input type="text" class="form-control" id="inputAdmin" disabled="disabled" value="${sessionScope.curUser}">
                      </div>
                    </div>
                    <div class="form-group">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-10 col-md-6">
                        <input type="text" class="form-control" id="inputAuthority" disabled="disabled" value="${sessionScope.authority}">
                      </div>
                    </div>

<%@page import="com.sys.card.bean.*" import="com.sys.card.dao.*"%>
    ...
    <script>
					...
					function send()
					{
                        if(flag)
                        {
						  ...
						  x.open("GET","CalculateStatistics?step=0",true);
					...
					function update()
					{
						...
						if(x.readyState==4 && x.status==200)
						{
							...
							if(x.responseText=="0")      
							{
								...
								sleep(1000);
								x.open("GET","CalculateStatistics?step="+step,true);
								x.onreadystatechange=update;
								x.send();
								return ;
							}
							...
							if(step==1)
						    {
							 x.open("GET","CalculateStatistics?step=1",true);
							 x.onreadystatechange=update;
							 x.send();
						    }
							else if(step==2)
						    {
								x.open("GET","CalculateStatistics?step=2",true);
								x.onreadystatechange=update;
								x.send();
						    }
							else if(step==3)
						    {
								x.open("GET","CalculateStatistics?step=3",true);
								x.onreadystatechange=update;
								x.send();
						    }
							else if(step==4)
						    {
								x.open("GET","CalculateStatistics?step=4",true);
								x.onreadystatechange=update;
								x.send();
						    }							
						}
